...
1. Empecemos con algo sencillo. 


2. Ahora que ya tenemos las medallas por país (y no por atleta `r emo::ji("wink")`), usando `group_by()` y los verbos de `dplyr`, creen un nuevo tibble (`oro_por_pais`) que tenga, de forma ordenada, la cantidad de medallas de oro que ganó cada país en toda la historia de los Juegos Olímpicos de verano (`summer_tbl`).
