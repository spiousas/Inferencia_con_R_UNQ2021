...
a) Usar `mutate` para agregar una nueva columna en la que los valores de la variable se transformen de modo que un 0 corresponda a la palabra "ceca" y un 0 a "cara".
