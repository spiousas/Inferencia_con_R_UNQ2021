...
Discuta los resultados obtenidos ($\beta$ y $\sigma$). Recuerde que para calcular el modelo puede usar la función lm, y para ver los resultados, summarise. Recuerde también guardar el resultado del modelo en una variable del entorno R; esto permitirá procesar posteriormente las estimaciones del modelo.
...
summarise(fm1Rail.m)
beta  = fm1Rail.m$coefficients["(Intercept)"]
sigma = summary(fm1Rail.m)$sigma
```
