...
$$R_{adj}^2 = 1 - \frac{sd^2_{residuos}}{sd^2} \frac{(n-k-1)}{(n-1)}$$
...
.huge[
Aprendimos a:
- Ajustar un modelo con **más de un preditor**
...
Ahora nos queda ver cómo seguir cuando tenemos más de un regresor.
]
