...
Aunque no lo crean esta infografía está hecha 100% utilizando **R**

.center.mid[
![:scale 80%](https://tacosdedatos.com/assets/blogposts/002_bbplot_ejemplo.png)
]
---
class: left, top, highlight-last-item
...
![:scale 30%](http://hexb.in/hexagons/shiny.png)
]
???
