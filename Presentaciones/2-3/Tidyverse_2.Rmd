...
.pull-left[
Por ejemplo, si queremos ordenar los valores únicos de una lista:
...
Una vez que tenemos los datos acomodados podemos usar las funciones de **dplyr** para crear una columna con los datos normalizados
...
Vamos a urdenar los casos de menos a mayor **sum_bill**
