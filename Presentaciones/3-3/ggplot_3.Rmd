...
.center[
```{r tweet-from-CedScherer, dpi=300, out.width="50%", echo=FALSE}
tweet_screenshot(
...
.pull-right[
```{r raincloud_plot_1-out, fig.show = "hold", ref.label="raincloud_plot_1", fig.align = "center", dpi=300, fig.width = 5, fig.height = 7, out.width="100%", echo=FALSE}
```
]
...
.pull-right[
```{r raincloud_plot_2-out, fig.show = "hold", ref.label="raincloud_plot_2", fig.align = "center", dpi=300, fig.width = 5, fig.height = 7, out.width="100%", echo=FALSE}
```
]
...
.pull-right[
```{r raincloud_plot_3-out, fig.show = "hold", ref.label="raincloud_plot_3", fig.align = "center", dpi=300, fig.width = 5, fig.height = 7, out.width="100%", echo=FALSE}
```
]
...
Más información sobre los **raincloud plots** se puede encontrar acá:
