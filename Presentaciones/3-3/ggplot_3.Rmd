...
```{r ggstatsplot, fig.show = "hold",fig.align = "center", dpi=300, fig.width = 8, fig.height = 5, out.width="60%", warning=FALSE}
library(ggstatsplot)
...
El campo de la visualización de datos (**Data viz**) es muy amplio y excede un poco este curso, pero como comunicadores de resultados es **MUY** recomendable que, además de conocer las herramientas para generar las figuras, reflexionemos sobre el tipo de representación que queremos utilizar. 
...
```{r dynamite_plot, fig.align = "center", dpi=300, fig.width = 5, fig.height = 5, out.width="50%", echo=FALSE}
set.seed(0)
n <- 20
...
```{r dynamite_plot_2, fig.align = "center", dpi=300, fig.width = 10, fig.height = 5, out.width="100%", echo=FALSE}
